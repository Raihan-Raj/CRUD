...
!(function() {
    ...
    n("Validator", function() {}),
            ...
            return (
                (r = {
                    ...
                    parseName: function(e) {
                        ...
                        return (-1 !== i && (!a || i > 1) ? ((t = e.substring(0, i)), (n = e.substring(i + 1))) : (t = e),
                            (o = n || t),
                            (i = o.indexOf("!")), -1 !== i && ((r = "strip" === o.substring(i + 1)), (o = o.substring(0, i)), n ? (n = o) : (t = o)), { moduleName: t, ext: n, strip: r }
                        );
                    },
                    xdRegExp: /^((\w+)\:)?\/\/([^\/\\]+)/,
        ...
        (function(e, t) {
            ...
            function h(e) {
                return e.replace(Ne, "ms-").replace(Re, m);
            }
            ...
            function A(e, t, n, o, i) {
                ...
                for (p.textContent = "", m = 0;
                    (a = f[m++]);)
                    if (o && Se.inArray(a, o) > -1) i && i.push(a);
                    else if (((u = Se.contains(a.ownerDocument, a)), (s = S(p.appendChild(a), "script")), u && x(s), n))
                    for (d = 0;
                        (a = s[d++]);) Ze.test(a.type || "") && n.push(a);
                return p;
            }
            ...
            function k(e, t, n, o, r, i) {
                ...
                if ((null == o && null == r ? ((r = n), (o = n = void 0)) : null == r && ("string" == typeof n ? ((r = o), (o = void 0)) : ((r = o), (o = n), (n = void 0))), !1 === r)) r = M;
                else if (!r) return e;
                return (
                    1 === i &&
                    ((a = r),
            ...
            function H(e, t) {
                ...
                if (1 === t.nodeType) {
                    if (Fe.hasData(e) && ((i = Fe.access(e)), (a = Fe.set(t, i)), (c = i.events))) {
                        ...
                        for (r in c)
                            for (n = 0, o = c[r].length; n < o; n++) Se.event.add(t, r, c[r][n]);
                    }
            ...
            function O(e, t, n) {
                ...
                return (
                    ...
                    ((a = n.getPropertyValue(t) || n[t]),
                        "" !== a || Se.contains(e.ownerDocument, e) || (a = Se.style(e, t)), !we.pixelBoxStyles() && ct.test(a) && dt.test(t) && ((o = s.width), (r = s.minWidth), (i = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = o), (s.minWidth = r), (s.maxWidth = i))),
                    void 0 !== a ? a + "" : a
                );
            }
            ...
            function U(e, t, n) {
                for (var o, r = ($.tweeners[t] || []).concat($.tweeners["*"]), i = 0, a = r.length; i < a; i++)
            ...
            function $(e, t, n) {
                ...
                for (Q(u, c.opts.specialEasing); i < a; i++)
                    if ((o = $.prefilters[i].call(c, e, u, c.opts))) return Te(o.stop) && (Se._queueHooks(c.elem, c.opts.queue).stop = o.stop.bind(o)), o;
                return (
                    Se.map(u, U, c),
            ...
            function te(e) {
                return function(t, n) {
                    ...
                    if (Te(n))
                        for (;
                            (o = i[r++]);) "+" === o[0] ? ((o = o.slice(1) || "*"), (e[o] = e[o] || []).unshift(n)) : (e[o] = e[o] || []).push(n);
                };
            }
            ...
            var Ae = (function(e) {
                function t(e, t, n, o) {
                    ...
                    if (!o && ((t ? t.ownerDocument || t : V) !== E && B(t), (t = t || E), D)) {
                        if (11 !== m && (l = he.exec(e)))
                            if ((r = l[1])) {
                                if (9 === m) {
                        ...
                        if (y.qsa && !W[e + " "] && (!L || !L.test(e))) {
                            if (1 !== m)(f = t), (p = e);
                                ...
                                for ((s = t.getAttribute("id")) ? (s = s.replace(Te, ye)) : t.setAttribute("id", (s = R)), u = A(e), i = u.length; i--;) u[i] = "#" + s + " " + d(u[i]);
                        ...
                        function(t, n, l) {
                            ...
                            if (l) {
                                ...
                                for (;
                                    (t = t[o]);)
                                    if (1 === t.nodeType || a)
                                        if (((d = t[R] || (t[R] = {})), (u = d[t.uniqueID] || (d[t.uniqueID] = {})), r && r === t.nodeName.toLowerCase())) t = t[o] || t;
                                        else {
                    ...
                    return (
                        ...
                        o(function(o, a, s, l) {
                            var c,
                                ...
                                T = n ? (i || (o ? e : b || r) ? [] : a) : w;
                            if ((n && n(w, T, s, l), r))
                                for (c = h(T, f), r(c, [], s, l), u = c.length; u--;)(d = c[u]) && (T[f[u]] = !(w[f[u]] = d));
                            if (o) {
                                if (i || e) {
                                    if (i) {
                ...
                function g(e) {
                    for (
                        var t,
                            ...
                            u = [
                                function(e, n, o) {
                                    var r = (!i && (o || n !== C)) || ((t = n).nodeType ? l(e, n, o) : c(e, n, o));
                                    return (t = null), r;
                                },
                            ]; s < r; s++
                    )
                        if ((n = v.relative[e[s].type])) u = [p(f(u), n)];
                            ...
                            if (((n = v.filter[e[s].type].apply(null, e[s].matches)), n[R])) {
                    ...
                    var r = n.length > 0,
                        ...
                        a = function(o, a, s, l, c) {
                            var u,
                                ...
                                S = T.length;
                            for (c && (C = a === E || a || c); m !== S && null != (u = T[m]); m++) {
                                if (i && u) {
                                    for (d = 0, a || u.ownerDocument === E || (B(u), (s = !D));
                                        (p = e[d++]);)
                                        if (p(u, a || E, s)) {
                                            l.push(u);
                                            break;
                ...
                try {
                    $.apply((U = Y.call(V.childNodes)), V.childNodes), U[V.childNodes.length].nodeType;
                } catch (e) {
                    $ = {
                        apply: U.length ?
                ...
                (B = t.setDocument = function(e) {
                    var t,
                        n,
                        o = e ? e.ownerDocument || e : V;
                    return o !== E && 9 === o.nodeType && o.documentElement ?
                        ((E = o),
                            (H = E.documentElement),
                            (D = !x(E)),
                            V !== E && (n = E.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ve, !1) : n.attachEvent && n.attachEvent("onunload", ve)),
                            ...
                            (y.getById = r(function(e) {
                                return (H.appendChild(e).id = R), !E.getElementsByName || !E.getElementsByName(R).length;
                            })),
                            y.getById ?
                                ...
                                (v.find.ID = function(e, t) {
                                    if (void 0 !== t.getElementById && D) {
                                        ...
                                        if (i) {
                                            ...
                                            for (r = t.getElementsByName(e), o = 0;
                                                (i = r[o++]);)
                                                if ((n = i.getAttributeNode("id")) && n.value === e) return [i];
                                        }
                                        return [];
                            ...
                            (r(function(e) {
                                    (H.appendChild(e).innerHTML = "<a id='" + R + "'></a><select id='" + R + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                            ...
                            (z = t ?
                                ...
                                function(e, t) {
                                    ...
                                    return (
                                        ...
                                        ((n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1),
                                            ...
                                            e === E || (e.ownerDocument === V && N(V, e)) ?
                                            -1 :
                                            t === E || (t.ownerDocument === V && N(V, t)) ?
                                            1 :
                                            k ?
                                            Z(k, e) - Z(k, t) :
                                            0 :
                                ...
                                function(e, t) {
                                    ...
                                    for (; s[o] === l[o];) o++;
                                    return o ? a(s[o], l[o]) : s[o] === V ? -1 : l[o] === V ? 1 : 0;
                                }),
                            E) :
                        E;
                }),
                                ...
                                function(t, n, l) {
                                    ...
                                    if (b) {
                                        ...
                                        if (((m = [a ? b.firstChild : b.lastChild]), a && w)) {
                                            for (
                                                p = b, d = p[R] || (p[R] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], f = c[0] === F && c[1], T = f && c[2], p = f && b.childNodes[f];
                                        ...
                                        } else if ((w && ((p = t), (d = p[R] || (p[R] = {})), (u = d[p.uniqueID] || (d[p.uniqueID] = {})), (c = u[e] || []), (f = c[0] === F && c[1]), (T = f)), !1 === T))
                                            for (;
                                                (p = (++f && p && p[h]) || (T = f = 0) || m.pop()) &&
                                                ((s ? p.nodeName.toLowerCase() !== g : 1 !== p.nodeType) || !++T || (w && ((d = p[R] || (p[R] = {})), (u = d[p.uniqueID] || (d[p.uniqueID] = {})), (u[e] = [F, T])), p !== t));
                ...
                return (
                    ...
                    (P = t.compile = function(e, t) {
                        var n,
                            ...
                            i = W[e + " "];
                        if (!i) {
                            for (t || (t = A(e)), n = t.length; n--;)(i = g(t[n])), i[R] ? o.push(i) : r.push(i);
                            (i = W(e, w(r, o))), (i.selector = e);
                        }
                        return i;
                    }),
                    (M = t.select = function(e, t, n, o) {
                        var r,
                            i,
                            a,
                            s,
                    ...
                    (y.sortStable = R.split("").sort(z).join("") === R),
            ...
            Se.fn.extend({
                ...
                is: function(e) {
                    return !!s(this, "string" == typeof e && Ce.test(e) ? Se(e) : e || [], !1).length;
                },
            });
            var Ge,
                Be = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
            ...
            (Se.event = {
                    ...
                    if (b && (l = b.events)) {
                        for (t = (t || "").match(De) || [""], c = t.length; c--;)
                            if (((s = rt.exec(t[c]) || []), (f = h = s[1]), (m = (s[2] || "").split(".").sort()), f)) {
                                ...
                                for (f in l) Se.event.remove(e, f + t[c], n, o, !0);
                ...
                dispatch: function(e) {
                    ...
                    if (((s.delegateTarget = this), !u.preDispatch || !1 !== u.preDispatch.call(this, s))) {
                        for (a = Se.event.handlers.call(this, s, c), t = 0;
            ...
            (Se.Event = function(e, t) {
                ...
                e && e.type ?
                    ((this.originalEvent = e),
                        (this.type = e.type),
                        (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? P : M),
            ...
            Se.each({
                ...
                Se.fn.extend({
                    ...
                    off: function(e, t, n) {
                        ...
                        return (
                            (!1 !== t && "function" != typeof t) || ((n = t), (t = void 0)), !1 === n && (n = M),
                            this.each(function() {
            ...
            Se.extend({
                    ...
                    clone: function(e, t, n) {
                        ...
                        if (!(we.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || Se.isXMLDoc(e)))
                            for (a = S(s), i = S(e), o = 0, r = i.length; o < r; o++) D(i[o], a[o]);
                        if (t)
                            if (n)
                                for (i = i || S(e), a = a || S(s), o = 0, r = i.length; o < r; o++) H(i[o], a[o]);
                            else H(e, s);
                    ...
                    cleanData: function(e) {
                        for (var t, n, o, r = Se.event.special, i = 0; void 0 !== (n = e[i]); i++)
                            if (Ve(n)) {
                                if ((t = n[Fe.expando])) {
                                    if (t.events)
                                        for (o in t.events) r[o] ? Se.event.remove(n, o) : Se.removeEvent(n, o, t.handle);
                                    n[Fe.expando] = void 0;
                                }
                    ...
                    style: function(e, t, n, o) {
                        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                            var r,
                                ...
                                l = ft.test(t),
                                c = e.style;
                            if ((l || (t = V(s)), (a = Se.cssHooks[t] || Se.cssHooks[s]), void 0 === n)) return a && "get" in a && void 0 !== (r = a.get(e, !1, o)) ? r : c[t];
                            (i = typeof n),
                        ...
                        return (
                            ...
                            this.each(function() {
                                ...
                                if (r) a[r] && a[r].stop && o(a[r]);
                                    ...
                                    for (r in a) a[r] && a[r].stop && vt.test(r) && o(a[r]);
                    ...
                    toggleClass: function(e, t) {
                        ...
                        return "boolean" == typeof t && o ?
                            ...
                            this.each(function() {
                                var t, r, i, a;
                                if (o)
                                    for (r = 0, i = Se(this), a = J(e);
                                        (t = a[r++]);) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
            ...
            Se.fn.extend({
                    val: function(e) {
                        var t,
                            ...
                            if (r)
                                return (t = Se.valHooks[r.type] || Se.valHooks[r.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : ((n = r.value), "string" == typeof n ? n.replace(Mt, "") : null == n ? "" : n);
                        }
                    },
                }),
                Se.extend({
                    ...
                    trigger: function(t, n, o, r) {
                        ...
                        if (
                            ...
                            if (!r && !d.noBubble && !ye(o)) {
                                for (l = d.delegateType || m, Ct.test(l + m) || (a = a.parentNode); a; a = a.parentNode) f.push(a), (s = a);
                                s === (o.ownerDocument || se) && f.push(s.defaultView || s.parentWindow || e);
                            }
                            for (i = 0;
                                (a = f[i++]) && !t.isPropagationStopped();)
                                (p = a),
                                (t.type = i > 1 ? l : d.bindType || m),
                                (u = (Fe.get(a, "events") || {})[t.type] && Fe.get(a, "handle")),
                                u && u.apply(a, n),
                                (u = c && a[c]) && u.apply && Ve(a) && ((t.result = u.apply(a, n)), !1 === t.result && t.preventDefault());
                            return (
                                (t.type = m),
                                r ||
                    ...
                    ajax: function(t, n) {
                            ...
                            x = {
                                ...
                                getResponseHeader: function(e) {
                                    ...
                                    if (u) {
                                        if (!s)
                                            for (s = {};
                                                (t = Vt.exec(a));) s[t[1].toLowerCase()] = t[2];
                                        t = s[e.toLowerCase()];
                                    }
                        ...
                        d && 0 == Se.active++ && Se.event.trigger("ajaxStart"),
                            ...
                            ((f = m.url.slice(i.length)),
                                m.data && (m.processData || "string" == typeof m.data) && ((i += (Et.test(i) ? "&" : "?") + m.data), delete m.data), !1 === m.cache && ((i = i.replace(Rt, "$1")), (f = (Et.test(i) ? "&" : "?") + "_=" + Bt++ + f)),
                                (m.url = i + f)),
        ...
        (function(e, t) {
            ...
            function n() {
                ...
                this.modal.classList.add("tingle-modal"),
                    ...
                    }, this), -1 !== this.opts.closeMethods.indexOf("button") &&
                    ...
                    this.modalBox.appendChild(this.modalBoxContent), -1 !== this.opts.closeMethods.indexOf("button") && this.modal.appendChild(this.modalCloseBtn),
            ...
            function r() {
                (this._events = { clickCloseBtn: this.close.bind(this), clickOverlay: a.bind(this), resize: this.checkOverflow.bind(this), keyboardNav: i.bind(this) }), -1 !== this.opts.closeMethods.indexOf("button") && this.modalCloseBtn.addEventListener("click", this._events.clickCloseBtn),
            ...
            return (
                ...
                (e.prototype.checkOverflow = function() {
                    this.modal.classList.contains("tingle-modal--visible") &&
                        (this.isOverflow() ? this.modal.classList.add("tingle-modal--overflow") : this.modal.classList.remove("tingle-modal--overflow"), !this.isOverflow() && this.opts.stickyFooter ? this.setStickyFooter(!1) : this.isOverflow() && this.opts.stickyFooter && (t.call(this), this.setStickyFooter(!0)));
                }), { modal: e }
            );
        }),
        (function(e, t) {
            e("mobiledetect", [], function() {
                ...
                return (
                    ...
                    (i.getVersionStr = function(e, t) {
                        ...
                        if (s.call(l, e))
                            for (n = l[e], r = n.length, o = 0; o < r; ++o)
                                if (null !== (a = n[o].exec(t))) return a[1];
                        return null;
                    }),
            ...
            var p,
                ...
                J = function(e) {
                    ...
                    if ((t && (t.parentNode.removeChild(t), G([document.documentElement, document.body], [S["no-backdrop"], S["toast-shown"], S["has-column"]])), !Y())) {
                        ...
                        var m = function(e) {
                            Ce.isVisible() && r !== e.target.value && Ce.resetValidationMessage(), (r = e.target.value);
                        };
                        return (
                            (s.oninput = m),
                            (l.onchange = m),
                ...
                oe = function(e) {
                    var t = V().querySelector("#" + S.content);
                ...
                re = function(e) {
                    ...
                    if (e.type)
                        if (-1 !== Object.keys(x).indexOf(e.type)) {
                            var o = Ce.getPopup().querySelector(".".concat(S.icon, ".").concat(x[e.type]));
                ...
                ae = function(e) {
                    var t = X(),
                        n = parseInt(null === e.currentProgressStep ? Ce.getQueueStep() : e.currentProgressStep, 10);
                ...
                Me = Object.freeze({
                    ...
                    showValidationMessage: function(e) {
                        ...
                        var o = this.getInput();
                        o && (o.setAttribute("aria-invalid", !0), o.setAttribute("aria-describedBy", S["validation-message"]), M(o), k(o, S.inputerror));
                    },
                    ...
                    _main: function(t) {
                        ...
                        !(function(e) {
                            ...
                            if (
                                (se(e),
                                    oe(e),
                                    "string" == typeof e.backdrop ? (L().style.background = e.backdrop) : e.backdrop || k([document.documentElement, document.body], S["no-backdrop"]), !e.backdrop && e.allowOutsideClick && h('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                            ...
                            e.showCloseButton ? (l.setAttribute("aria-label", e.closeButtonAriaLabel), E(l)) : H(l),
                                ...
                                ie(e),
                                ne(e),
                                ee(e.footer, c), !0 === e.animation ? G(t, S.noanimation) : k(t, S.noanimation),
                        ...
                        var i = { popup: O(), container: L(), content: V(), actions: z(), confirmButton: _(), cancelButton: W(), closeButton: U(), validationMessage: j(), progressSteps: X() };
                        ...
                        return new Promise(function(t) {
                            ...
                            for (
                                ...
                                var A = S[y[x]],
                                    P = B(i.content, A);
                                if ((m = n.getInput(y[x]))) {
                                    for (var C in m.attributes)
                                        if (m.attributes.hasOwnProperty(C)) {
                                            var L = m.attributes[C].name;
                            ...
                            switch (r.input) {
                                ...
                                case "range":
                                    var O = B(i.content, S.range),
                                        ...
                                        R = O.querySelector("output");
                                    (N.value = r.inputValue), (N.type = r.input), (R.value = r.inputValue), E(O);
                                    break;
                                case "select":
                                    var V = B(i.content, S.select);
                                    if (((V.innerHTML = ""), r.inputPlaceholder)) {
                                        var F = document.createElement("option");
                                        (F.innerHTML = r.inputPlaceholder), (F.value = ""), (F.disabled = !0), (F.selected = !0), V.appendChild(F);
                                    }
                                    g = function(e) {
                                        e.forEach(function(e) {
                                                var t = e[0],
                                                ...
                                                (o.value = t), (o.innerHTML = n), r.inputValue.toString() === t.toString() && (o.selected = !0), V.appendChild(o);
                                            }),
                                            E(V),
                                            V.focus();
                                    };
                    ...
                    update: function(e) {
                        ...
                        Object.keys(e).forEach(function(n) {
                            Ce.isUpdatableParameter(n) ? (t[n] = e[n]) : h('Invalid parameter to update: "'.concat(n, '". Updatable params are listed here: TODO (@limonte) add link'));
                        });
            ...
            r(function() {
                function e(e) {
                    if (void 0 != e.data) {
                        ...
                        void 0 != t.status &&
                            "success" == t.status &&
                            (void 0 != t.url && -1 !== t.url.indexOf("http") && (window.location.href = t.url),
                                void 0 != t.type && (("redirect" != t.type && "gw_redirect" != t.type) || (window.location.href = t.url)),
                                void 0 != t.type && "otp" == t.type && (window.location.href = t.url),
                                void 0 != t.type && ("resize" == t.type && void 0 != t.height && t.height > 100 && (f ? (c.style.minHeight = window.outerHeight - 100 + "px") : (c.height = t.height)), console.log(t.type)));
                    }
                    console.log(t);
                }
                ...
                function i() {
                    ...
                    var t = g.prop("postdata") ? g.prop("postdata") : {},
                        n = g.prop("token");
                    r.ajax({
                        url: T.endpoint,
                        dataType: "json",
                        method: "POST",
                        data: { order: T.order, cart_json: JSON.stringify(t), _token: n },
                        xhr: function() {
                                ...
                                t.addEventListener(
                                    ...
                                    function(t) {
                                        if (t.lengthComputable) {
                                            ...
                                            console.log("hello", n), e.animate({ width: "100%" }, 50, function() {});
                                        }
                                    }, !1
                                ),
                                t
                        ...
                        function(e) {
                            console.log(e.GatewayPageURL),
                                ...
                                setTimeout(function() {
                                    l(e.GatewayPageURL + "?full=1", e.storeLogo);
                                }, 10) :
                                s("Error!", "Payment processing fails! Error generating payment URL", "error", "Ok") :
                                s("Error!", "Payment processing fails! Transaction is fail to generate", "error", "Ok") :
                                s("Error!", "Payment processing fails! Invalid response from server", "error", "Ok");
                        },
                        function(e) {
                            o.fire({ title: "Error in Communication", text: "Oops! Something wrong, Try again", type: "error", confirmButtonText: "please login" }), a();
                        }
                    );
                }

                function a() {
                    console.log("hello"), r(m).fadeOut("slow");
                }
                ...
                function l(e, n) {
                    if ((console.log("jh"), null !== f)) a(), window.open(e, "_blank");
                    else {
                        console.log("isMobile" + f),
                            (u = new t.modal({
                                footer: !0,
                                stickyFooter: !1,
                                closeMethods: ["button"],
                            ...
                            (e += "?full=1"),
                            console.log("is url" + e);
                        var o = document.createElement("div"),
                            r = document.createElement("div"),
                            i = document.createElement("div");
                        (r.className = "client_logo"), (i.className = "client_logo_inner");
                        var s = document.createElement("div");
                        s.setAttribute("class", "iframeWrap"),
                        ...
                        l.setAttribute("src", n),
                            l.setAttribute("alt", "Logo"),
                            i.appendChild(l),
                            r.appendChild(i),
                            o.appendChild(r),
                            o.appendChild(s),
                            u.setContent(o),
                            u.addFooterBtn("&times;", "tingle-modal__close", function() {
                                u.close();
                            }),
                            u.open();
                    }
                ...
                var c, u;
                window.popup = null;
                (window.openedDomain = ""), (window.zpay_validation_code = "zpay@ssl"), (window.windowName = "easy"), (window.trackedWindows = {}), console.log("FORM GENERATOR INITIATED ");
                var d = !0;
                console.log("test data"),
                    ...
                    (window.onblur = function() {
                        (d = !1), console.log("blur true");
                    }),
                    window.addEventListener(
                        "message",
                        function(t) {
                            console.log("WE HAVE RECEIVED ALIEN MESSAGE", t), e(t);
                        }, !1
                    );
                var p = new n(window.navigator.userAgent);
                console.log(p);
                var f = p.mobile();
                f && r("body").addClass("pop_up_mobile_device"), console.log(f);
                var m = document.createElement("div");
                m.setAttribute("class", "shaz_back_overlay"), m.setAttribute("style", "display:none");
                var h = document.createElement("div");
                h.setAttribute("class", "sloader lock");
                r(".shaz_back_overlay");
                r(m).html(
                ...
                var b = r("#myForm"),
                    ...
                    w = b.attr(),
                    T = g.attr();
                if ((console.log("BUTTON VALUES", JSON.stringify(T)), null != T)) {
                    if (void 0 == T.order || "" == T.order) return void o.fire({ title: "Order Required", text: "Order required to pay", type: "error", confirmButtonText: "please login" });
                    if (void 0 == T.endpoint || "" == T.endpoint) return void o.fire({ title: "Endpoint Required", text: "Endpoint url required to pay", type: "error", confirmButtonText: "please login" });
                }
                console.log(w), !window.XMLHttpRequest &&
                    "ActiveXObject" in window &&
                    (window.XMLHttpRequest = function() {
                        return new ActiveXObject("MSXML2.XMLHttp");
                    }),
                    r(document).on("click", "#sslczPayBtn", function(e) {
                        e.preventDefault();
                        var t = new n(window.navigator.userAgent);
                        console.log(t);
                        var o = t.mobile();
                        o && r("body").addClass("pop_up_mobile_device"), console.log(o);
                        var a = document.createElement("div");
                        a.setAttribute("class", "shaz_back_overlay"), a.setAttribute("style", "display:none");
                        var s = document.createElement("div");
                        s.setAttribute("class", "sloader lock");
                        r(".shaz_back_overlay");
                        r(a).html(
                                '<div class="lock-center"><div class="icon-lock" style="clear: left; float: left"><div class="lock-top-1" style="background-color: #fff"></div><div class="lock-top-2"></div><div class="lock-body" style="background-color: #24c875"></div><div class="lock-hole"></div></div></div>'
                            ),
