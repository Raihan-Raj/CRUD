...
(function(h) {
    ...
    function Ga(a, b) {
        var c = l.defaults.column,
            ...
            c = h.extend({}, l.models.oColumn, c, { nTh: b ? b : H.createElement("th"), sTitle: c.sTitle ? c.sTitle : b ? b.innerHTML : "", aDataSort: c.aDataSort ? c.aDataSort : [d], mData: c.mData ? c.mData : d, idx: d });
        a.aoColumns.push(c);
        c = a.aoPreSearchCols;
        ...
        if (b)
            for (e = b.length - 1; 0 <= e; e--) {
                ...
                for (g = q.length; f < g; f++)
                    ...
                    q[f], n);
                else if ("string" === typeof q[f]) { j = 0; for (i = m.length; j < i; j++)("_all" == q[f] || h(m[j].nTh).hasClass(q[f])) && d(j, n) }
            }
    ...
    function Ka(a, b, c, d) {
        var e = [],
            ...
            q = a._rowReadObject,
            d = d !== k ? d : q ? {} : [],
            r = function(a, b) { if ("string" === typeof a) { var c = a.indexOf("@"); - 1 !== c && (c = a.substring(c + 1), N(a)(d, b.getAttribute(c))) } },
            G = function(a) {
    ...
    function ta(a, b, c) {
        ...
        a.oAjaxData =
            b;
        u(a, null, "preXhr", [a, b]);
        a.fnServerData ? a.fnServerData.call(j, a.sAjaxSource, h.map(b, function(a, b) { return { name: b, value: a } }), i, a) : a.sAjaxSource || "string" === typeof g ? a.jqXHR = h.ajax(h.extend(n, { url: g || a.sAjaxSource })) : "function" === typeof g ? a.jqXHR = g.call(j, b, i, a) : (a.jqXHR = h.ajax(h.extend(n, g)), g.data = f)
    }
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            n = h("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", f ? Qa(i, f) : i).on("mouseup", function() { setTimeout(function() { i.call(n[0]) }, 10) }).on("keypress.DT", function(a) { if (13 == a.keyCode) return !1 }).attr("aria-controls", c);
        h(a.nTable).on("search.dt.DT", function(b, c) { if (a === c) try { n[0] !== H.activeElement && n.val(e.sSearch) } catch (d) {} });
        return b[0]
    }
    ...
    function tb(a) {
        ...
        m && i.append(h("<div/>", { "class": f.sScrollFoot }).css({ overflow: "hidden", border: 0, width: d ? !d ? null : w(d) : "100%" }).append(h("<div/>", { "class": f.sScrollFootInner }).append(n.removeAttr("id").css("margin-left",
    ...
    function ma(a) {
        ...
        if (a.scrollBarVis !== L && a.scrollBarVis !== k) a.scrollBarVis = L, aa(a);
            ...
            t && I(function(a) { a.style.width = "" }, R);
            f = p.outerWidth();
            if ("" === c) {
                u.width = "100%";
    ...
    function Ha(a) {
        ...
        m && (b.style.width = w(m));
        if ((m || f) && !a._reszEvt) b = function() { h(E).on("resize.DT-" + a.sInstance, Qa(function() { aa(a) })) }, d ? setTimeout(b, 1E3) : b(), a._reszEvt = !0
    }
    ...
    function Y(a) {
        ...
        c = h.isPlainObject(b);
        var n = [];
        f = function(a) { a.length && !Array.isArray(a[0]) ? n.push(a) : h.merge(n, a) };
        Array.isArray(b) &&
            f(b);
        c && b.pre && f(b.pre);
        f(a.aaSorting);
        ...
        for (a = 0; a < n.length; a++) {
            ...
            f = e[i].aDataSort;
            b = 0;
            for (c = f.length; b < c; b++) g = f[b], j = e[g].sType || "string", n[a]._idx === k && (n[a]._idx = h.inArray(n[a][1], e[g].asSorting)), d.push({ src: i, col: g, dir: n[a][1], index: n[a]._idx, type: j, formatter: l.ext.type.order[j + "-pre"] })
        }
        return d
    }
    ...
    function Nb(a) { return function() { var b = [Aa(this[l.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments)); return l.ext.internal[a].apply(this, b) } }
    var l = function(a) {
            this.$ = function(a, b) { return this.api(!0).$(a, b) };
            this._ = function(a, b) { return this.api(!0).rows(a, b).data() };
            this.api = function(a) { return a ? new s(Aa(this[v.iApiIndex])) : new s(this) };
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    for (i = r.length; j < i; j++) {
                        var o = r[j];
                        if (o.nTable ==
                            this || o.nTHead && o.nTHead.parentNode == this || o.nTFoot && o.nTFoot.parentNode == this) { var s = g.bRetrieve !== k ? g.bRetrieve : m.bRetrieve; if (c || s) return o.oInstance; if (g.bDestroy !== k ? g.bDestroy : m.bDestroy) { o.oInstance.fnDestroy(); break } else { K(o, 0, "Cannot reinitialise DataTable", 3); return } }
                        if (o.sTableId == this.id) { r.splice(j, 1); break }
                    }
                    if (null === e || "" === e) this.id = e = "DataTables_Table_" + l.ext._unique++;
                    var p = h.extend(!0, {}, l.models.oSettings, { sDestroyWidth: q[0].style.width, sInstance: e, sTableId: e });
                    p.nTable = this;
                    p.oApi =
                        b.internal;
                    p.oInit = g;
                    ...
                    kb(p, g.aoColumnDefs, r, function(a, b) { la(p, a, b) });
                    if (v.length) {
    ...
    h.extend(s.prototype, {
        ...
        unique: function() { return new s(this.context, ra(this)) },
        unshift: x.unshift
    });
    ...
    s.registerPlural = t = function(a, b, c) {
        s.register(a, c);
        s.register(b, function() { var a = c.apply(this, arguments); return a === this ? this : a instanceof s ? a.length ? Array.isArray(a[0]) ? new s(a.context, a[0]) : a[0] : k : a })
    };
    ...
    t("tables().nodes()", "table().node()", function() { return this.iterator("table", function(a) { return a.nTable }, 1) });
    ...
    t("tables().containers()", "table().container()", function() { return this.iterator("table", function(a) { return a.nTableWrapper }, 1) });
    o("draw()", function(a) {
    ...
    var bb = function(a, b, c, d, e) {
            ...
            a = v.selector[a];
            if (a.length) { i = 0; for (h = a.length; i < h; i++) f = a[i](d, e, f) }
            return ra(f)
        },
    ...
    t("rows().cache()", "row().cache()", function(a) { return this.iterator("row", function(b, c) { var d = b.aoData[c]; return a === "search" ? d._aFilterData : d._aSortData }, 1) });
    t("rows().invalidate()", "row().invalidate()", function(a) { return this.iterator("row", function(b, c) { ea(b, c, a) }) });
        ...
        this.iterator("row", function(b, c, d) {
            ...
            for (h = e.length; g < h; g++) {
                ...
                if (i.nTr !== null) i.nTr._DT_RowIndex =
                    g;
                if (m !== null) { i = 0; for (n = m.length; i < n; i++) m[i]._DT_CellIndex.row = g }
            }
            ...
            c = this.iterator("table", function(c) {
                ...
                return bb("column", e, function(a) {
                    ...
                    if (k) switch (k[2]) {
                        ...
                        case "visible":
                            b = parseInt(k[1], 10);
                            if (b < 0) { var l = h.map(g, function(a, b) { return a.bVisible ? b : null }); return [l[l.length + b]] }
                            return [ba(c, b)];
                        case "name":
    ...
    t("columns().dataSrc()", "column().dataSrc()", function() { return this.iterator("column", function(a, b) { return a.aoColumns[b].mData }, 1) });
    t("columns().cache()", "column().cache()", function(a) { return this.iterator("column-rows", function(b, c, d, e, f) { return ka(b.aoData, f, a === "search" ? "_aFilterData" : "_aSortData", c) }, 1) });
    t("columns().nodes()", "column().nodes()", function() { return this.iterator("column-rows", function(a, b, c, d, e) { return ka(a.aoData, e, "anCells", b) }, 1) });
        ...
        function(a, b) {
            ...
            a !== k && this.iterator("table", function(d) {
                ...
                d.aiDisplay.length || h(d.nTBody).find("td[colspan]").attr("colspan",
                    W(d));
                za(d);
                c.iterator("column", function(c, d) { u(c, null, "column-visibility", [c, d, a, b]) });
                (b === k || b) && c.columns.adjust()
            });
            return d
        });
    t("columns().indexes()", "column().index()", function(a) { return this.iterator("column", function(b, c) { return a === "visible" ? ca(b, c) : c }, 1) });
    ...
    o("cells()", function(a, b, c) {
        ...
        var d = c ? {
            ...
            g, j, i, l, d = this.iterator("table", function(a, b) {
                var c = [];
                g = 0;
                for (j = f[b].length; g < j; g++) { i = 0; for (l = e[b].length; i < l; i++) c.push({ row: f[b][g], column: e[b][i] }) }
                return c
            }, 1),
    ...
    t("cells().cache()", "cell().cache()", function(a) { a = a === "search" ? "_aFilterData" : "_aSortData"; return this.iterator("cell", function(b, c, d) { return b.aoData[c][a][d] }, 1) });
    t("cells().render()", "cell().render()", function(a) { return this.iterator("cell", function(b, c, d) { return B(b, c, d, a) }, 1) });
    t("cells().indexes()", "cell().index()", function() { return this.iterator("cell", function(a, b, c) { return { row: b, column: c, columnVisible: ca(a, c) } }, 1) });
    ...
    l.tables = l.fnTables =
        function(a) {
            ...
            var c = h.map(l.settings, function(b) { if (!a || a && h(b.nTable).is(":visible")) return b.nTable });
            return b ? new s(c) : c
        };
    ...
    o("destroy()", function(a) {
        ...
        return this.iterator("table", function(b) {
            var c = b.nTableWrapper.parentNode,
                ...
                f = h(f),
                k = h(b.nTableWrapper),
                m = h.map(b.aoData, function(a) { return a.nTr }),
                o;
            b.bDestroying = true;
        ...
        o(b + "s().every()",
            function(a) {
                var d = this.selector.opts,
                    e = this;
                return this.iterator(b, function(f, g, h, i, l) { a.call(e[b](g, b === "cell" ? h : d, b === "cell" ? d : k), g, h, i, l) })
            })
    });
        ...
        pageButton: {
            _: function(a, b, c, d, e, f) {
                var g = a.oClasses,
                    ...
                    t;
                try { t = h(b).find(H.activeElement).data("dt-idx") } catch (s) {}
                r(h(b).empty(), d);
                t !== k && h(b).find("[data-dt-idx=" + t + "]").trigger("focus")
            }
        }
    });
    h.extend(l.ext.type.detect, [function(a, b) { var c = b.oLanguage.sDecimal; return ab(a, c) ? "num" + c : null }, function(a) { if (a && !(a instanceof Date) && !bc.test(a)) return null; var b = Date.parse(a); return b !== null && !isNaN(b) || M(a) ? "date" : null }, function(a,
    ...
    h.extend(l.ext.type.search, { html: function(a) { return M(a) ? a : typeof a === "string" ? a.replace(Ob, " ").replace(Ca, "") : "" }, string: function(a) { return M(a) ? a : typeof a === "string" ? a.replace(Ob, " ") : a } });
    var Ba =
        function(a, b, c, d) {
    ...
    h.each(l, function(a, b) { h.fn.DataTable[a] = b });
