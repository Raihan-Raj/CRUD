...
! function(d) {
    ...
    a.DEFAULTS = { pattern: "priority-columns", stickyTableHeader: !0, fixedNavbar: ".navbar-fixed-top", addDisplayAllBtn: !0, addFocusBtn: !0, focusBtnIcon: "glyphicon glyphicon-screenshot", mainContainer: window, i18n: { focus: "Focus", display: "Display", displayAll: "Display all" } }, a.prototype.wrapTable = function() { this.$tableScrollWrapper.wrap('<div class="table-wrapper"/>'), this.$tableWrapper = this.$tableScrollWrapper.parent() }, a.prototype.createButtonToolbar = function() {
    ...
    }, a.prototype.displayAll = function(t, i) { this.$displayAllBtn && this.$displayAllBtn.toggleClass("btn-primary", t), this.$table.toggleClass("display-all", t), this.$tableClone && this.$tableClone.toggleClass("display-all", t), i && d(window).trigger(this.displayAllTrigger) }, a.prototype.preserveDisplayAll = function() {
        var t = "table-cell";
        ...
        var i = this;
        i.$tableClone = i.$table.clone(), i.$tableClone.prop("id", this.id + "-clone"), i.$tableClone.find("[id]").each(function() { d(this).prop("id", d(this).prop("id") + "-clone") }), i.$tableClone.wrap('<div class="sticky-table-header"/>'), i.$stickyTableHeader = i.$tableClone.parent(), i.$stickyTableHeader.css("height", i.$thead.height() + 2), i.$table.before(i.$stickyTableHeader), d(this.options.mainContainer).bind("scroll", function() { d.proxy(i.updateStickyTableHeader(), i) }), d(window).bind("resize", function(t) { d.proxy(i.updateStickyTableHeader(), i) }), d(i.$tableScrollWrapper).bind("scroll", function() { d.proxy(i.updateStickyTableHeader(), i) }), i.useFixedSolution = !e() || 8 <= function() {
            { if (e()) { var t = parseFloat(("" + (/CPU.*OS ([0-9_]{1,5})|(CPU like).*AppleWebKit.*Mobile/i.exec(navigator.userAgent) || [0, ""])[1]).replace("undefined", "3_2").replace("_", ".").replace("_", "")); return t } return 0 }
        ...
        n.$hdrCells.each(function(t) {
            ...
            if (e || (e = n.idPrefix + t, i.prop("id", e)), "" === o && (o = i.attr("data-col-name")), i.is("[data-priority]") && -1 !== i.data("priority")) {
                var a = d('<li class="checkbox-row"><input type="checkbox" name="toggle-' + e + '" id="toggle-' + e + '" value="' + e + '" /> <label for="toggle-' + e + '">' + o + "</label></li>"),
                    s = a.find("input");
                n.$dropdownContainer.append(a), a.click(function() { s.prop("checked", !s.prop("checked")), s.trigger("change") }), d("html").hasClass("lt-ie9") && s.click(function() { d(this).trigger("change") }), a.find("label").click(function(t) { t.stopPropagation() }), a.find("input").click(function(t) { t.stopPropagation() }).change(function() {
                    var e = d(this),
                        t = e.val(),
                ...
                }).bind("updateCheck", function() { "none" !== i.css("display") ? d(this).prop("checked", !0) : d(this).prop("checked", !1) })
            }
        ...
        var t = this;
        t.$bodyRows.each(function() { t.setupRow(d(this), t.headerColIndices) })
        ...
        2 === this.$thead.find("tr").length && d(this.$thead.find("tr")[1]).find("th").each(function(t) { s.headerRowIndices[t] = s.headerColIndices[n[t] + t] })
        ...
        t.find("[id]").each(function() { d(this).prop("id", d(this).prop("id") + "-clone") }), t.appendTo(this.$tableClone), this.$dropdownContainer.find("input").trigger("change")
    ...
    function e() { return !!(navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i)) }
    ...
    }, d.fn.responsiveTable.Constructor = a, d.fn.responsiveTable.noConflict = function() { return d.fn.responsiveTable = t, this }, d(document).on("ready.responsive-table.data-api", function() {
        d(".table-responsive[data-pattern]").each(function() {
            var t = d(this);
            t.responsiveTable(t.data())
        })
    }), d(document).on("click.dropdown.data-api", ".dropdown-menu .checkbox-row", function(t) { t.stopPropagation() }), d(document).ready(function() { d("html").removeClass("no-js").addClass("js"), void 0 !== window.matchMedia || void 0 !== window.msMatchMedia || void 0 !== window.styleMedia ? d("html").addClass("mq") : d("html").addClass("no-mq"), "ontouchstart" in window ? d("html").addClass("touch") : d("html").addClass("no-touch") })
}(jQuery);