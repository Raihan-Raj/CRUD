    ...
    function j(t, f, o) {
        ...
        function z(n, i, o, s) {
            function e(t) {
                ...
                return (!!r &&
                    !(V() && !s.doNotReject) &&
                    ((e = d),
                        (t = f.cssClasses.tap), !((e.classList ? e.classList.contains(t) : new RegExp("\\b" + t + "\\b").test(e.className)) && !s.doNotReject) &&
        ...
        function B(t, e) {
            ...
            e.handleNumbers.some(k) ||
                (1 === e.handleNumbers.length && ((o = a[e.handleNumbers[0]].children[0]), (v += 1), ft(o, f.cssClasses.active)),
                    t.stopPropagation(),
                    (n = z(c.move, y, R, {
                        target: t.target,
                        handle: o,
                    ...
                    t.cursor && ((w.style.cursor = getComputedStyle(t.target).cursor), 1 < a.length && ft(d, f.cssClasses.drag), w.addEventListener("selectstart", lt, !1)),
                    e.handleNumbers.forEach(function(t) {
                        I("start", t);
                    }));
        }
        ...
        function W(t, e, r, n, i, o) {
            ...
            return (
                ...
                (n && 0 < e && ((s = S.getAbsoluteDistance(t[e - 1], f.margin, !1)), (r = Math.max(r, s))), i && e < a.length - 1 && ((s = S.getAbsoluteDistance(t[e + 1], f.margin, !0)), (r = Math.min(r, s)))),
                1 < a.length && f.limit && (n && 0 < e && ((s = S.getAbsoluteDistance(t[e - 1], f.limit, !1)), (r = Math.min(r, s))), i && e < a.length - 1 && ((s = S.getAbsoluteDistance(t[e + 1], f.limit, !0)), (r = Math.max(r, s)))),
                f.padding && (0 === e && ((s = S.getAbsoluteDistance(0, f.padding[0], !1)), (r = Math.max(r, s))), e === a.length - 1 && ((s = S.getAbsoluteDistance(100, f.padding[1], !0)), (r = Math.min(r, s)))), !((r = ct((r = S.getStep(r)))) === t[e] && !o) && r
            );
        }
        ...
        function Z(t) {
            var e, r;
            l[t] &&
                ((r = 100), (e = "translate(" + $(J((e = (e = 0) !== t ? m[t - 1] : e), (r = (r = t !== l.length - 1 ? m[t] : r) - e)) + "%", "0") + ")"), (r = "scale(" + $(r / 100, "1") + ")"), (l[t].style[f.transformRule] = e + " " + r));
        }
